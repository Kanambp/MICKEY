...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "254114148625") {
			let evaled,
				text = q,
...
me = m.sender
teks = `*「  ${global.botname} Script 」*\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nHi @${me.split('@')[0]} 👋\nDont forget to donate yeah🍜 👇 https://wa.me//+254114148625`
sendXeonBotIncMessage(from, { 
text: teks,
mentions:[sender],
contextInfo:{
...
if (!q) return replygcxeon(`Example ${prefix+command} Kanamp`)
XeonStickWait()
...
const audio = await xeonplaymp3.mp3(anup3k.url)
await XeonBotInc.sendMessage(m.chat,{
...
case 'addprem':
if (!XeonTheCreator) return XeonStickOwner()
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 254114148625`)
...
let e = String(err)
XeonBotInc.sendMessage("254114148625@s.whatsapp.net", { text: "Hello developer Kanambo, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
